...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ESParlamentary.ce_estado_civil'
        db.alter_column('parliament_esparlamentary', 'ce_estado_civil', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'ESParlamentary.ce_declaracion_actividades_url'
        db.alter_column('parliament_esparlamentary', 'ce_declaracion_actividades_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'ESParlamentary.ce_comisiones'
        db.alter_column('parliament_esparlamentary', 'ce_comisiones', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'ESParlamentary.ce_declaracion_bienes_url'
        db.alter_column('parliament_esparlamentary', 'ce_declaracion_bienes_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'ESParlamentary.ce_curriculum'
        db.alter_column('parliament_esparlamentary', 'ce_curriculum', self.gf('django.db.models.fields.TextField')(default=''))


    def backwards(self, orm):

        # Changing field 'ESParlamentary.ce_estado_civil'
        db.alter_column('parliament_esparlamentary', 'ce_estado_civil', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ESParlamentary.ce_declaracion_actividades_url'
        db.alter_column('parliament_esparlamentary', 'ce_declaracion_actividades_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=200))

        # Changing field 'ESParlamentary.ce_comisiones'
        db.alter_column('parliament_esparlamentary', 'ce_comisiones', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ESParlamentary.ce_declaracion_bienes_url'
        db.alter_column('parliament_esparlamentary', 'ce_declaracion_bienes_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=200))

        # Changing field 'ESParlamentary.ce_curriculum'
        db.alter_column('parliament_esparlamentary', 'ce_curriculum', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
